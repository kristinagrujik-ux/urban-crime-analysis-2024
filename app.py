...
# 3.4 СПЕЦИЈАЛИЗИРАН ПРИКАЗ ЗА КОРУПЦИЈА (Подесен со колони за да не биде премногу широк)
    ...
    try:
        ...
        korupcija_clean = pd.DataFrame({
            ...
            # Процентот го земаме директно бидејќи веќе е во соодветен формат во Excel
        ...
        # Правилно прикажување на текстот за процентите (множиме со 100 за приказ со знак %)
        ...
        # 1. Кривични дела и 2. Сторители еден до друг
        ...
        # 3. Трет графикон: Промена % со точни вредности
