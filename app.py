...
if "Криумчарење" in selected_sheet or "мигранти" in selected_sheet.lower():
    ...
    # Го делиме подолгиот текст во два реда за да стои исправно без да се скратува
    kategorii = valid_mig.iloc[:, 0].astype(str).str.replace('Број на криумчарени мигранти', 'Број на криумчарени\nмигранти')
