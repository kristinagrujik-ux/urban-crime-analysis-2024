...
# 1. СПЕЦИЈАЛЕН СЛУЧАЈ: Табела за Кривични дела против државата (Само табела, без графикони)
...
# 2. ОСТАНАТИ СЛУЧАИ: Графикони и табели
    ...
    if "Криумчарење" in selected_sheet or "мигранти" in selected_sheet.lower():
        ...
        with col2:
            ...
            chart_final = (bar_chart + text_chart).properties(width=550, height=380).configure_view(stroke=None)
